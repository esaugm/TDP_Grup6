 ...
 * @author josi
 */
public final class DlgClienteModifica extends javax.swing.JDialog {
	...
	*/
	...
	if (validvalue) {
            validvalue = (validstring.isValidCP(c_codigoPostalCliente.getText()));
            if (!validvalue) {
    ...
    public void SetDialogData(Client cliente) {
	c_numeroCliente.setText(cliente.getNumClient()+"");
	c_fechAltaCliente.setText(cliente.getDataAlta().toString());
	c_nifCliente.setText(cliente.getNif());
	c_nombreCliente.setText(cliente.getnom());
	c_apellidosCliente.setText(cliente.getcognoms());
	c_direccionCliente.setText(cliente.getadreca());
	c_poblacionCliente.setText(cliente.getPoblacio());
	c_codigoPostalCliente.setText(cliente.getCodiPostal()+"");
    }
     ...
     */
    public DlgClienteModifica(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

	setTitle(TDSLanguageUtils.getMessage("client.SS2.Client.ModificaDialog"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgClienteModifica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
